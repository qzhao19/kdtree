...
class KDTree(object):
    ...
    def build_tree(self):
        ...
        while stack:
            ...
            _data, _indices, _left_hyper_rect, _right_hyper_rect, left_child, right_child = self.tree.pop()
            ...
            if n_samples < self.leaf_size:
                ...
                stack.append((data[:, :n_samples//2], indices[:n_samples//2], depth+1, node_ptr, True))
                stack.append((data[:, n_samples//2:], indices[n_samples//2:], depth+1, node_ptr, False))
                ...
                left_hyper_rect[1, partition_axis] = mid_val
                right_hyper_rect[0, partition_axis] = mid_val
                # append node to tree
